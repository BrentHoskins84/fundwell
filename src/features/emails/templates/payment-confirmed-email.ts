          ...
          <tr>
            <td style="background-color: #27272A; padding: 32px; border-radius: 0 0 8px 8px;">
                ...
                <tr>
                  <td style="padding: 20px;">
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 8px 0; color: #a1a1aa; font-size: 14px;">Status:</td>
                        <td style="padding: 8px 0; color: #22c55e; font-size: 16px; font-weight: bold; text-align: right;">
                          ✓ Paid
                        </td>
                      </tr>
                    </table>
              ...
              <p style="margin: 0 0 24px 0; color: #fafafa; font-size: 16px;">
                Your square is locked in. Good luck!
              </p>
